...
I architect cross-platform ecosystems from the ground up. I design system architectures, build applications across web, desktop, mobile, and CLI, and implement my own paradigms in working code.

**Python** is my primary language — 40+ projects, from cryptographic libraries to full-stack Django services. I also work with C#, Kotlin, Go, and JavaScript to deliver consistent logic across platforms.

I am an independent researcher with 4 published paradigms in computer security, information theory, and computational complexity — all with DOI and practical implementations.
...
> *For detailed research publications and academic work, visit my **[Website](https://smartlegionlab.ru)** or **[ORCID](https://orcid.org/0009-0006-3427-9611)**.*
...
| Research | Link |
|----------------------------------|------------------------------------------------------------------------------|
| Pointer-Based Security Paradigm | [GitHub](https://github.com/smartlegionlab/pointer-based-security-paradigm) |
| Local Data Regeneration Paradigm | [GitHub](https://github.com/smartlegionlab/local-data-regeneration-paradigm) |
...
| Project | Description |
|------------------------------------------------------------------------------|-----------------------------------------|
| [Exact TSP Solver](https://github.com/smartlegionlab/exact-tsp-solver) | Go implementation with Branch and Bound |
| [Smart TSP Benchmark](https://github.com/smartlegionlab/smart-tsp-benchmark) | Algorithm testing infrastructure |
| [Smart TSP Oracle](https://github.com/smartlegionlab/smart-tsp-oracle) | Python exact solver |
| [Smart TSP Solver](https://github.com/smartlegionlab/smart-tsp-solver) | Python heuristic solver |

**Related Research:**

| Research | Link |
|----------------------------------------|------------------------------------------------------------------------------------|
| Position-Candidate-Hypothesis Paradigm | [GitHub](https://github.com/smartlegionlab/position-candidate-hypothesis-paradigm) |
...
| Platform | Repository |
|----------|------------------------------------------------------------------------------------------|
| Desktop | [Smart 2FA Manager Desktop](https://github.com/smartlegionlab/smart-2fa-manager-desktop) |
| Android | [Smart 2FA Manager Android](https://github.com/smartlegionlab/smart-2fa-manager-android) |
| Bash | [Smart 2FA Manager Bash](https://github.com/smartlegionlab/smart-2fa-manager-bash) |
| CLI | [Smart 2FA Manager CLI](https://github.com/smartlegionlab/smart-2fa-manager-cli) |
...
| Publication | DOI |
|------------------------------------------|--------------------------------------------------------------------|
| Pointer-Based Security Paradigm | [10.5281/zenodo.17204738](https://doi.org/10.5281/zenodo.17204738) |
| Local Data Regeneration Paradigm | [10.5281/zenodo.17264327](https://doi.org/10.5281/zenodo.17264327) |
| Deterministic Game Engine (Technical Report) | [10.5281/zenodo.17383447](https://doi.org/10.5281/zenodo.17383447) |
| Position-Candidate-Hypothesis Paradigm | [10.5281/zenodo.17614888](https://doi.org/10.5281/zenodo.17614888) |
